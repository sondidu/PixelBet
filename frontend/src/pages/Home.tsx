      ...
      <section className="px-4 pb-12">
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            PixelBet is a blockchain-based betting platform where players wager
            on the outcome of a randomly generated colour grid. A House creates
            a round by choosing a grid size and number of colours. Players then
            bet on which colour they think will dominate the board — all without
            ...
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 mt-1">
                  ...
                  7), bet limits, and a betting window duration. They also
                  commit a secret seed hash to the blockchain.
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 mt-1">
                  ...
                  ETH. Bet early for a higher payout multiplier (up to 3x) —
                  later bets get lower multipliers (down to 1x).
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 mt-1">
                  After betting closes, the House reveals their original seed.
                  The contract verifies it matches the committed hash, generates
                  the board, and determines the winning colour.
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 mt-1">
                  Players who bet on the dominant colour withdraw their
                  winnings. The House collects a 5% fee from the pot.
                </p>
              </div>
            </li>
          </ol>
      ...
      <section className="px-4 pb-12">
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            The board is generated deterministically from the House's secret
            seed. The seed is locked in (via its hash) before any bets are
            placed, so no one can manipulate the outcome.
          </p>
